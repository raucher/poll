...
<section class="spoiler quiz-spoiler">
	<article class="container">
		...
		<?php 
			...
			*/
				echo CHtml::activeRadioButtonList(UserAnswer::model(), "[$k]av_id", $data, array(
                    'class'=>'pull-left',
                    'uncheckValue'=>null,
                ));
			?>
			...
			<?php 
				echo CHtml::submitButton(Yii::t('poll', 'End poll'), array(
                    'class'=>'send-res flex-hidden btn btn-primary btn-large span4 pull-right',
                )); ?>
		<!--</form>-->
